					...
					<table class="table">
						<tbody id="more-tr">
							<tr>
								...
								<td>
									<select name='debit_account[]' class="form-control input-sm debit_account Select2 ">
								...
								<td>
									<select name='credit_account[]' class="form-control input-sm credit_account select2 ">
										<option value="">--SELECT--</option>
										@foreach ($ledger_all as $ledgerid=>$ledgername)
										<option value="{{$ledgerid}}">{{$ledgername}}</option>
                                        @endforeach
								...
								<td class="col-sm-1">
									<input type="text" name="description[]" class="form-control input-sm description input-sm" placeholder="Description" style="width:84%;">
