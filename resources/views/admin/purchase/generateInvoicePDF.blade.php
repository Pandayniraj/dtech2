    ...
    <!-- /.row --><br><br>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          <?php
          $n= 0;
          $perunitexciseamt=\DB::table('importpurchase')->join('purch_order_details','importpurchase.purchase_order_id', '=', 'purch_order_details.order_no',)->where('cost_type',"EXCISE DUTY")->select('importpurchase.amount','purch_order_details.qty_invoiced')->get()->toArray();
