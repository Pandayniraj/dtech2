        ...
        <div class='col-md-12'>
            <div class="box-body">
                ...
                <div class="col-md-12">
                        ...
                        <form method="POST" action="/admin/supplierreturn/{{$purchasereturn->id}}">
                            {{ csrf_field() }}
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <label>Purchase bill id</label>
                                          <input type="text" class="form-control pull-right " name="purchase_bill_id" value="{{$purchasereturn->purchase_bill_id}}" id="purchase_bill_no" required="" readonly>
                                     </div>
                                     <div class="col-md-3">
                                        <label>Purchase bill No</label>
                                  
                                          <input type="text" class="form-control pull-right " name="purchase_bill_no" value="{{$purchasereturn->purchase_bill_no}}" id="pur_billno" required="" readonly>
                                     </div>
                                      ...
                                      <div class="col-md-3">
                                        <label>Client Name:</label>
                                          ...
                                          <input type="text" class="form-control pull-right " name="client_name" value="{{$purchasereturn->supplier_name}}" id="customer_name" readonly>
                                          <input type="hidden" name="client_id" id="client_id" value="{{$purchasereturn->supplier_id}}">
                                     </div>
                                    
                                     <div class="col-md-3">
                                        <label>Return Date:</label>
                                          <input type="text" class="form-control pull-right datepicker" name="return_date" value="{{$purchasereturn->return_date}}" id="return_date" required="" readonly>
                                     </div>
                                 ...
                                 <div class="col-md-12">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control pull-right" name="purchase_order_date" value="{{$purchasereturn->purchase_order_date}}" id="purchase_order_date" readonly>
                                     </div>
                                    <div class="col-md-3 form-group" style="">
                                        <label for="user_id">Purchase Owner</label>
                                        {!! Form::select('user_id',  $users, $purchasereturn->user_id, ['class' => 'form-control input-sm', 'id'=>'user_id']) !!}
                                     </div>
                                        ...
                                        <div class="form-group">
                                         <label>Status:</label>
                                          <select type="text" class="form-control pull-right " name="status" id="status">
                                            <option value="parked" @if($purchasereturn->status == 'parked') selected @endif>Parked</option>
                                            <option value="completed" @if($purchasereturn->status == 'completed') selected @endif>Completed</option>
                                          </select>
                                        </div>
                                    <!-- /.input group -->
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                          <label>PAN NO:</label>
                                          <input type="text" class="form-control pull-right " name="pan_no" value="{{ $purchasereturn->pan_no }}" id="pan_no" readonly>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <label>Vat:</label>
                                          ...
                                          <option value="yes" @if($purchasereturn->vat_type == 'yes') selected @endif>Yes(13%)</option>
                                            <option value="no" @if($purchasereturn->vat_type == 'no') selected @endif>No</option>
                                          </select>
                                  </div>
                                        ...
                                        <div class="form-group">
                                            <label>Is renewal:</label>
                                              <select type="text" class="form-control pull-right " name="is_renewal" id="is_renewal">
                                                 <option value="0" @if($purchasereturn->is_renewal == '0') selected @endif>No</option>
                                                 <option value="1" @if($purchasereturn->is_renewal == '1') selected @endif>Yes</option>
                                              </select>
                                        </div>
                                    <!-- /.input group -->
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                         <label>Location:</label>
                                           {!! Form::select('into_stock_location', [''=>'Select']+$productlocation, $purchasereturn->into_stock_location, ['class' => 'form-control label-default','id'=>'location_id']) !!}
                                        </div>
                                    <!-- /.input group -->
                                    </div>
                                </div>
...
<hr/>
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      @foreach($purchase_return_detail as $odv)
                                      ...
                                      <tr>  
                                          ...
                                          <td>
                                              <input type="text" class="form-control invoice_price" placeholder="Unit" value="{{$odv->unitname->name}}" required="required" readonly>
                                              <input  type="hidden" name="units[]" value="{{$odv->units}}">

                                          </td>
                                          <td>
                                              <input type="number" class="form-control purchase_quantity" name="purchase_quantity[]" placeholder="Quantity" min="1" value="{{$odv->purchase_quantity}}" required="required" readonly>
                                          </td>
                                        
                                          <td>
                                              <input type="number" class="form-control quantity" name="return_quantity[]" placeholder="Return Quantity" min="1" value="{{$odv->return_quantity}}" required="required" >
                                          </td>

                                          <td>
                                             <input type="number" class="form-control purchase_price" name="purchase_price[]" placeholder="Purchase Price" min="1" value="{{$odv->purchase_price}}" required="required" readonly>
                                          </td>
                                          <td>
                                              <input type="number" class="form-control price" name="return_price[]" placeholder="Credit Price" min="1" value="{{$odv->return_price}}" required="required" >
                                          </td>

                                           <td>
                                               <input type="number" class="form-control total" name="return_total[]" placeholder="Total" value="{{$odv->return_total}}" readonly="readonly">
                                          </td>
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <input type="text" class="form-control invoice_price" placeholder="Unit" value="{{$odv->unitname->name}}"  readonly>
                                              <input  type="hidden" name="custom_units[]" value="{{$odv->units}}">
                                          </td>
                                           
                                          <td>
                                              <input type="number" class="form-control purchase_quantity" name="custom_purchase_qty[]" placeholder="Quantity" min="1" value="{{$odv->purchase_quantity}}"  readonly>
                                          </td>

                                          <td>
                                              <input type="number" class="form-control quantity" name="custom_return_qty[]" placeholder="Return Quantity" min="1" value="{{$odv->return_quantity}}" required="required">
                                          </td>

                                          <td>
                                              <input type="number" class="form-control purchase_price" name="custom_purchase_price[]" placeholder="Credit Qty" min="1" value="{{$odv->purchase_price}}" required="required" readonly>
                                          </td>

                                          <td>
                                              <input type="number" class="form-control price" name="custom_return_price[]" placeholder="Credit Price" min="1" value="{{$odv->return_price}}" required="required" >
                                          </td>
                                          <td>
                                           <input type="number" class="form-control total" name="custom_return_total[]" placeholder="Total" value="{{$odv->return_total}}" readonly="readonly" >
                                           </td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td id="sub-total">{{$purchasereturn->subtotal}}</td>
                                            <td>&nbsp; <input type="hidden" name="subtotal" id="subtotal" value="{{$purchasereturn->subtotal}}"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" style="text-align: right;">Order Discount (%)</td>
                                            <td><input type="number" min="0" name="discount_percent" id="discount_amount" value="{{$purchasereturn->discount_percent}}" onKeyUp="if(this.value>99){this.value='99';}else if(this.value<0){this.value='0';}" step ='any'></td>
                                            <td>&nbsp;</td>
                                        </tr>
                                       
                                        <tr>
                                            <td colspan="7" style="text-align: right;">Taxable Amount</td>
                                            <td id="taxable-amount">{{$purchasereturn->taxable_amount}}</td>
                                            <td>&nbsp; <input type="hidden" name="taxable_amount" id="taxableamount" value="{{$purchasereturn->taxable_amount}}"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" style="text-align: right;">Tax Amount</td>
                                            <td id="taxable-tax">{{$purchasereturn->tax_amount}}</td>
                                            <td>&nbsp; <input type="hidden" name="taxable_tax" id="taxabletax" value="{{$purchasereturn->tax_amount}}"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" style="text-align: right; font-weight: bold;">Total Amount</td>
                                            <td id="total">{{$purchasereturn->total_amount}}</td>
                                            <td>
                                                <input type="hidden" name="total_tax_amount" id="total_tax_amount" value="{{$purchasereturn->total_amount}}">
                                                <input type="hidden" name="final_total" id="total_" value="{{$purchasereturn->total_amount}}">
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <div class="col-md-6 form-group" style="margin-top:5px;">
                                    ...
                                    <textarea class="form-control TextBox comment" name="comments" id="comments">{{$purchasereturn->comments}}</textarea>
                                </div>
  ...
  $(document).ready(function() {
   ...
   $('#purchase_bill_no').on('change',function(){
    ...
    function populatePurchaseInfo(invoiceinfo){
        ...
        $('#pur_billno').val(invoiceinfo.bill_no).prop("readonly", true); 
