                    ...
                    <table class="table table-bordered">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="font-size: 16.5px"><strong>Dr {{number_format($dr_total,2)}}</strong></td>
                          <td style="font-size: 16.5px"><strong>Cr {{number_format($cr_total,2)}}</strong></td>
                          <td></td>
                        </tr>
