...
class Expense extends Model
{
    ...
    protected $fillable = ['user_id', 'expenses_account','currency', 'bill_no','amount', 'paid_through', 'vendor_id', 'date', 'reference', 'attachment', 'org_id', 'project_id','tag_id','entry_id', 'expense_type', 'fiscal_year_id'];
