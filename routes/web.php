...
Route::get('invoicetrash', ['as' => 'admin.invoicetrash.index', 'uses' => 'InvoiceTrashController@index']);
        ...
        // Ajax User Leave Check/products/GetProductDetailAjax/
        ...
        Route::get('/project/calendar', ['as' => 'admin.project.calendar', 'uses' => 'ProjectCalendarController@index']);
        //costterm-niraj
        Route::get('costterm', ['as' => 'admin.costterm.index', 'uses' => 'CostTermController@index']);
        Route::get('costterm/create', ['as' => 'admin.costterm.create', 'uses' => 'CostTermController@create']);
        Route::post('costterm/store', ['as' => 'admin.costterm.store', 'uses' => 'CostTermController@store']);
        Route::get('costterm/edit/{id}', ['as' => 'admin.costterm.edit', 'uses' => 'CostTermController@edit']);
        Route::post('costterm/update/{id}', ['as' => 'admin.costterm.update', 'uses' => 'CostTermController@update']);
        Route::get('costterm/confirm-delete/{id}',['as'=>'admin.costterm.confirm-delete','uses'=>'CostTermController@deleteModal']);
        Route::get('costterm/delete/{id}',['as'=>'admin.costterm.delete','uses'=>'CostTermController@destroy']);
        Route::any('costterm/getledgerid/{id}', ['as' => 'admin.costterm.Getledgerid','uses' => 'CostTermController@getledgerid']);
